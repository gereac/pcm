...
public class JobRunner {
   ...
   * @param widget
   */
  public static void runDelayedInUIThread(final Widget widget,
   ...
   * @param widget
   */
  public static void runInUIThread(int delay, final Widget widget,
      final Runnable runnable) {
   ...
   * @param widget
   */
  public static void runInUIThread(int delay, boolean forceAsync,
      final Widget widget, final Runnable runnable) {
    Assert.isNotNull(runnable);

    /* Run directly if already in UI Thread */
    if (!forceAsync && delay == 0 && (widget == null || !widget.isDisposed())
   ...
   * @param widget
   */
  public static void runSyncedInUIThread(final Widget widget,
      final Runnable runnable) {
    Assert.isNotNull(runnable);
  ...
  public static void runInBackgroundWithBusyIndicator(final Runnable runnable) {
    ...
    if (display == null)
      throw new IllegalStateException(
          "Method was not called from the UI-Thread!"); //$NON-NLS-1$
